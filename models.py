...
KEYS_TO_FILTER_FROM_DB = [ATTR_ENTITY_ID, ATTR_AREA_ID, ATTR_ENTITY_PICTURE, ATTR_FRIENDLY_NAME, ATTR_HIDDEN, ATTR_ICON, ATTR_UNIT_OF_MEASUREMENT, ATTR_DEVICE_CLASS, ATTR_EDITABLE]
